...
class PartIndexDe extends Model
{
    use Searchable;
    ...
    public function searchableAs()
    {
        if(env('INDEX_APPENDIX') !== null) {
            return 'part_index_de_'.env('INDEX_APPENDIX');
        }

        return 'part_index_de';
    }
    ...
    public function toSearchableArray()
    {
        ...
        $array['cutting_edge_diameter'] = trim((string)$this->cutting_edge_diameter);
