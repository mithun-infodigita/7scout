...
class GroupSingleResourceForCategories extends JsonResource
{
    /**
    ...
    public function toArray($request)
    {
        return [
            ...
            'image_url'                                 =>  $this->category->getFirstMediaUrl('categoryImage'),
            'drawing_url'                               =>  $this->category->getFirstMediaUrl('categoryDrawing'),
